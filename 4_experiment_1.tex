...
\begin{table}[h!]
    ...
    \subfloat[不一致度]{
        \begin{tabular}{c|c|c} \hline
            & multiple CNN & Dropout network from single CNN \\ \hline
           Average KL & 0.051 $\pm$ 0.15 & 0.043 $\pm$ 0.12 \\
           Vote Entropy & 0.062 $\pm$ 0.24 & 0.059 $\pm$ 0.13 \\
           \hline
       \end{tabular}
    }
    ...
    \subfloat[不一致度]{
        \begin{tabular}{c|c|c} \hline
            & multiple CNN & Dropout network from single CNN \\ \hline
           Average KL & 0.061 $\pm$ 0.19 & 0.051 $\pm$ 0.12 \\
           Vote Entropy & 0.071 $\pm$ 0.20 & 0.063 $\pm$ 0.19 \\
           \hline
       \end{tabular}
    }
